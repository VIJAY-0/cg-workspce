...
export const COLORS = {
  ...
  saving: 'text-indigo-400',
  starting: 'text-blue-400',
  offline: 'text-zinc-500',
  bgRunning: 'bg-emerald-500/10',
  bgPaused: 'bg-amber-500/10',
};
...
export const Icons = {
  ...
  Pause: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="4" height="16" x="6" y="4" rx="1"/><rect width="4" height="16" x="14" y="4" rx="1"/></svg>
  ),
  Save: (props: any) => (
  ...
  Git: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="18" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><path d="M6 9v7c0 1.1.9 2 2 2h7"/><path d="M18 15V9c0-1.1-.9-2-2-2h-1"/><path d="m9 10 3-3-3-3"/></svg>
  ),
  Terminal: (props: any) => (
